...
const Gallery = () => {
  ...
  const [activePic, setActivePic] = useState("/img/SingleProduct/02.jpg");
  ...
  const modalProps = {
    ...
    img: activePic ? activePic : "/img/SingleProduct/02.jpg",
  };
    ...
    <div>
      ...
      <div className={Style.smallPicsContainer}>
        <div className={Style.smallPicPreview} onClick={show}>
          <img src="/img/SingleProduct/02.jpg" alt="" />
        </div>
        <div className={Style.smallPicPreview}>
          <img src="/img/SingleProduct/03.jpg" alt="" onClick={show} />
        </div>
        <div className={Style.smallPicPreview}>
          <img src="/img/SingleProduct/04.jpg" alt="" onClick={show} />
        </div>
        <div className={Style.smallPicPreview}>
          <img src="/img/SingleProduct/05.jpg" alt="" onClick={show} />
        </div>
        <div className={Style.smallPicPreview}>
          <img src="/img/SingleProduct/06.jpg" alt="" onClick={show} />
            ...
            <div className={Style.modalSmallPicContainer}>
              ...
              >
                ...
                <div
                  ...
                  onClick={(e) => avtivePic(e)}
                >
                  <img src="/img/SingleProduct/03.jpg" alt="" />
                </div>
                <div
                  className={Style.modalSmallPic}
                  onClick={(e) => avtivePic(e)}
                >
                  <img src="/img/SingleProduct/04.jpg" alt="" />
                </div>
                <div
                  className={Style.modalSmallPic}
                  onClick={(e) => avtivePic(e)}
                >
                  <img src="/img/SingleProduct/05.jpg" alt="" />
                </div>
                <div
                  className={Style.modalSmallPic}
                  onClick={(e) => avtivePic(e)}
                >
                  <img src="/img/SingleProduct/06.jpg" alt="" />
                </div>
                <div
                  className={Style.modalSmallPic}
                  onClick={(e) => avtivePic(e)}
                >
                  <img src="/img/SingleProduct/07.jpg" alt="" />
                </div>
                <div
                  className={Style.modalSmallPic}
                  onClick={(e) => avtivePic(e)}
                >
                  <img src="/img/SingleProduct/08.jpg" alt="" />
                </div>
                <div
                  className={Style.modalSmallPic}
                  onClick={(e) => avtivePic(e)}
                >
                  <img src="/img/SingleProduct/09.jpg" alt="" />
                </div>
                <div
                  className={Style.modalSmallPic}
                  onClick={(e) => avtivePic(e)}
                >
                  <img src="/img/SingleProduct/10.jpg" alt="" />
                </div>
              </div>
            </div>
          </div>
